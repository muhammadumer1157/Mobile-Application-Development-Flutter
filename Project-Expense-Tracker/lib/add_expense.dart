...
class _AddExpenseState extends State<AddExpense> {
  ...
  String _category = "";
  String _formattedDate = DateFormat.yMd().format(DateTime.now());
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null && picked != DateTime.now()) {
      setState(() {
        _formattedDate = DateFormat.yMd().format(picked);
      });
    }
  }
              ...
              children: [
                      ...
                      try {
                        if (_category == "") {
                          Flushbar(
                            ...
                            messageText: Text('Select category!',
                                style: Theme.of(context).textTheme.bodyText1),
                            duration: const Duration(seconds: 3),
                          ).show(context);
                        } else {
                          setIdandAmount();
                          if (remainingAmount > double.parse(_amount)) {
                            ...
                            db
                              ...
                              final docIdToSave = <String, dynamic>{
                                'Id': doc.id,
                              };
                              db
                                  .collection("Expenses")
                                  ...
                                  .collection("ExpenseData")
                                  .doc(doc.id)
                                  .set(docIdToSave, SetOptions(merge: true));
                              Flushbar(
                                flushbarPosition: FlushbarPosition.TOP,
                                margin: const EdgeInsets.all(8),
                                borderRadius: BorderRadius.circular(8),
                                ...
                                titleText: Text('Add Success',
                                    style:
                                        Theme.of(context).textTheme.bodyText2),
                                messageText: Text('Expense is added!',
                                    style:
                            ...
                            double remaining =
                                remainingAmount - double.parse(_amount);
                            ...
                            Flushbar(
                              ...
                              titleText: Text('Add Failed',
                                  style: Theme.of(context).textTheme.bodyText2),
                              messageText: Text('Low income amount!',
                                  style: Theme.of(context).textTheme.bodyText1),
                              duration: const Duration(seconds: 3),
                            ).show(context);
                          }
                        ...
                        Flushbar(
                          ...
                          titleText: Text('Add Failed',
                              style: Theme.of(context).textTheme.bodyText2),
                          messageText: Text(
                              'Make sure amount and description is added else try later!',
                              style: Theme.of(context).textTheme.bodyText1),
                          duration: const Duration(seconds: 3),
                        ).show(context);
                      }
                ...
                TextButton(
                    onPressed: () {
                      setState(() {
                        _amountCtl.text = "0";
                        _descriptionCtl.text = "Description";
                      });
                    },
